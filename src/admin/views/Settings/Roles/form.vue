...
<script>
    ...
    function initialize(to) {
        let urls = {
            'add': `/api/role_permission/create`,
            'edit': `/api/role_permission/${to.params.id}/edit`
        };
        ...
        methods: {
            setData(res) {
                ...
                if (this.$route.meta.mode === 'edit') {
                    this.store = `/api/role_permission/${this.$route.params.id}?_method=PUT`;
                    this.title = 'Edit';
