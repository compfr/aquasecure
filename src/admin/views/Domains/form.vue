<template>
    <div v-if="show">
        <b-card :title="$route.meta.mode && $route.meta.mode === 'edit' ? 'Edit Domain' : 'Add New Domain'">
            <b-row>
                <b-col cols="12">
                    <b-form-group
                        label="Frameworks"
...
<script>
    ...
    function initialize(to) {
        let urls = {
            ...
            'edit': `/api/domains/${to.params.id}/edit`
        };
        ...
        methods: {
            setData(res) {
                ...
                if (this.$route.meta.mode === 'edit') {
                    this.store = `/api/domains/${this.$route.params.id}?_method=PUT`;
                    this.title = 'Edit';
