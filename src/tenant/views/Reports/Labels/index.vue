...
<!--                    />-->
        ...
        <b-sidebar id="sidebar-backdrop"
                   ...
                   backdrop :title="`${formType} Label`" right shadow width="50%">
            <div class="px-1 py-2">
                <template>
                    <div>
                        <FormLabel v-if="showFormSideBar" :form-type="formType" :form-id="selectedLabel"
        ...
        <b-sidebar id="sidebar-backdrop-1"
                   ...
                   backdrop :title="`Label Detail`" right shadow width="50%">
            <div class="px-1 py-2">
                <template>
                    <div>
                        <ShowLabel v-if="showSideBar" :form-id="selectedLabel" />
                    </div>
                </template>
            </div>
        </b-sidebar>
...
<script>
    ...
    import FormLabel from "@/tenant/views/Reports/Labels/FormLabel";
    import ShowLabel from "@/tenant/views/Reports/Labels/ShowLabel";
