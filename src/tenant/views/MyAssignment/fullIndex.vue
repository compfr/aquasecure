            ...
            <b-row class="align-items-center">
                <b-col md="4">
                    <b-form-group
                        label="Task Type"
                    >
                        <x-tag-input :positionRelative="true" :removable="true" keyIndex="task_type_id"
                ...
                <b-col md="4">
                    <b-form-group
                        label="Status"
                    >
                        <x-tag-input :positionRelative="true" :removable="true" keyIndex="status_id"
                ...
                <b-col md="4">
                    <b-form-group
                        label="Urgency"
                    >
                        <x-tag-input :positionRelative="true" :removable="true" keyIndex="urgency_id"
