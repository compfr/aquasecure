<template>
    ...
    >
        ...
        >
            ...
            >
                <!-- Title & SubTitle -->
                <div class="card-title-width">
                    <b-card-title>{{ $attrs.title }}
                        <b-badge v-if="$attrs.count" variant="primary" class="ml-1">
                            {{ $attrs.count }}
                        </b-badge>
                    </b-card-title>
                ...
                >
                    <div slot="additionalHeader">
                        <slot name="additionalHeaderBtn"></slot>
                    </div>
                </b-card-actions-container>
            </div>
...
<script>
    import {
        BCard, BCardTitle, BCardSubTitle, BCardBody, BCollapse, BOverlay, BRow, BCol, BBadge
    } from 'bootstrap-vue'
