    ...
    <div>
        ...
        <b-card>
            ...
            <panel ref="panel" :url-api="urlApi" :columns="columns" :resource="resource"
                ...
                <div slot="action" slot-scope="props" class="text-nowrap">
                    ...
                    <!--                        class="cursor-pointer"-->
                    <!--                    />-->
                    <!--                    <template v-if="props.item.can_edit == 1">-->
                    <!--                        <feather-icon-->
        ...
        <b-sidebar id="sidebar-backdrop"
            ...
            <div class="px-1 py-2">
                <template>
                    <div>
                        <UseCaseLibraryForm v-if="showFormSideBar" :form-type="formType" :form-id="selectedUseCase"
...
<script>
    ...
    import UseCaseLibraryForm from "@/tenant/views/UseCaseLibrary/UseCaseLibraryForm";
    import ShowUseCaseLibrary from "@/tenant/views/UseCaseLibrary/ShowUseCaseLibrary";
