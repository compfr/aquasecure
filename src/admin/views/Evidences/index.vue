...
<script>
    ...
    import TagForm from "@/admin/views/Tags/TagForm.vue";
    import TagShow from "@/admin/views/Tags/TagShow.vue";
    import EvidenceTagForm from "@/admin/views/Evidences/form.vue";
    import EvidenceTagShow from "@/admin/views/Evidences/show.vue";
