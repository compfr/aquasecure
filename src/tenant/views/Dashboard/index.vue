...
<script>
    ...
    import WidgetLineChart from "@/tenant/views/Components/WidgetLineChart";
    import WidgetBarChart from "@/tenant/views/Components/WidgetBarChart";
    import WidgetBarChartHorizontal from "@/tenant/views/Components/WidgetBarChartHorizontal";
