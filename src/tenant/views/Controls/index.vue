...
<script>
    ...
    import ControlForm from "@/tenant/views/Controls/ControlForm";
    import ShowControl from "@/tenant/views/Controls/ShowControl";
                    ...
                    if (res.data.saved) {
                        ...
                        this.$toast({
                            ...
                            props: {
                                title: 'Success',
                                icon: 'BellIcon',
                                text: 'GRC Data Updated Successfully',
                                variant: 'success'
                            },
                        })
                        // this.reload()
